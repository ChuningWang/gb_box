...
Use to initiate the Box Model (generate IC and Forcing, etc.)
...
from gb_box.utilities import gb_box_rivers
...
# ------------------------- functionals ---------------------------------------------------
def get_area_volume(h_u, h_i, h_d, grid_file, box_method=1):
...
# 
# # -----------------------------------------------------------------------------------------
# def get_area_volume(hu, hi, hd, pth='~/Documents/gb_roms/grd/GB_lr_grd.nc', boxMethod=1):
#     """ calculate area and volume for each box """
# 
